# =============================================================================
# Dell Motherboard Hardware Configuration Module
# =============================================================================
#
# Dell motherboard-specific hardware monitoring and configuration for optimal performance.
#
# What it does:
# - Loads kernel modules for Dell motherboard hardware monitoring
# - Configures temperature and voltage monitoring (coretemp, nct6775)
# - Enables Dell WMI support for hardware management
...
#
# Requirements:
# - Compatible Dell motherboard (OptiPlex, Precision, Latitude, Inspiron, XPS and similar)
# - Intel/AMD chipset with Nuvoton sensor support
# - Dell WMI interface support
# - Compatible audio subsystem
#
# Usage:
# - Imported by device configurations with Dell motherboards
...

{
  ...
  # Kernel Modules
  # ============================================================================
  # Load necessary kernel modules for Dell motherboard hardware monitoring
  # These modules provide access to temperature sensors, fan controls, and
  # other hardware monitoring features specific to Dell motherboards
  boot.kernelModules = [
    # ========================================================================
    ...
    # ========================================================================
    "dell_wmi"      # Dell Windows Management Instrumentation driver
  ...
  # Kernel Parameters
  # ============================================================================
  # For Dell motherboards, these kernel parameters are often needed for full
  ...
  # ============================================================================
  # Create lm_sensors configuration for Dell motherboard compatibility
  # This provides compatibility with lm_sensors and other monitoring tools
  environment.etc."sysconfig/lm_sensors".text = ''
    # ========================================================================
    # Dell Motherboard Hardware Monitoring Configuration
    # ========================================================================
    # Generated by NixOS module for Dell OptiPlex, Precision, Latitude, Inspiron, XPS and similar motherboards
    # This configuration enables hardware monitoring modules for temperature,
    # voltage, and fan speed monitoring on Dell motherboards
